package org.zbh.fame.fame3.modelling.descriptors;
 ...
 */
public class PartialSigmaChargeDescriptorPatched extends AbstractAtomicDescriptor {
    ...
    /**
     *  Constructor for the PartialSigmaChargeDescriptorPatched object
     */
    public PartialSigmaChargeDescriptorPatched() {
        peoe = new GasteigerMarsiliPartialCharges();
    }

    /**
     *  Gets the specification attribute of the PartialSigmaChargeDescriptorPatched
     *  object
     *
    ...
    public DescriptorSpecification getSpecification() {
        return new DescriptorSpecification("http://www.blueobelisk.org/ontologies/chemoinformatics-algorithms/#partialSigmaCharge", this.getClass().getName(), "$Id: 24040c1892ee3563853c1dd82e11afe187c8460e $", "The Chemistry Development Kit");
    }

    /**
     *  Sets the parameters attribute of the PartialSigmaChargeDescriptorPatched
     *  object
     *
    ...
    public void setParameters(Object[] params) throws CDKException {
        if (params.length > 1) {
            throw new CDKException("PartialSigmaChargeDescriptorPatched only expects one parameter");
        }
    ...
    /**
     *  Gets the parameters attribute of the PartialSigmaChargeDescriptorPatched object
     *
    ...
    /**
     *  Gets the parameterNames attribute of the PartialSigmaChargeDescriptorPatched
     *  object
     *
    ...
    /**
     *  Gets the parameterType attribute of the PartialSigmaChargeDescriptorPatched
     *  object
     *
